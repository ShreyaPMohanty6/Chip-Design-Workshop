...
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............April 02, 2026 at 16:37:36                     //
//                                                                           //
...
//***************************************************************************//
  ...
  module test_scripts_FULLSCAN_counter_atpg ;
...
//***************************************************************************//
  ...
  counter
    counter_inst (
      ...
      .m        ( part_PIs[3] ),      // pinName = m; testOffset = 0.000000;  scanOffset = 0.000000;  
      .rst      ( part_PIs[4] ),      // pinName = rst;  tf = +SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
      .count    ({part_POs[8]  ,      // pinName = count[7]; 
                  part_POs[7]  ,      // pinName = count[6]; 
                  part_POs[6]  ,      // pinName = count[5]; 
                  part_POs[5]  ,      // pinName = count[4]; 
                  part_POs[4]  ,      // pinName = count[3]; 
                  part_POs[3]  ,      // pinName = count[2]; 
                  part_POs[2]  ,      // pinName = count[1]; 
                  part_POs[1]}),      // pinName = count[0]; 
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    part_POs [1] = global_term,     // pinName = count[0]; 
    part_POs [2] = global_term,     // pinName = count[1]; 
    part_POs [3] = global_term,     // pinName = count[2]; 
    part_POs [4] = global_term,     // pinName = count[3]; 
    part_POs [5] = global_term,     // pinName = count[4]; 
    part_POs [6] = global_term,     // pinName = count[5]; 
    part_POs [7] = global_term,     // pinName = count[6]; 
    part_POs [8] = global_term,     // pinName = count[7]; 
    part_POs [9] = global_term;      // pinName = scan_out;  tf =  SO  ; 


  assign ( supply0, supply1 ) // CR = 1 
    counter_inst.scan_in = part_S_CR_1_TM_1 [8] ,   // CR = 1;  pos = 1;  Pin Index = 4;  Pin Name = scan_in;  pinInvFromLatch = no;  Latch Index = 17;  Latch Name = \count_reg[0].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[1] .SI = part_S_CR_1_TM_1 [7] ,   // CR = 1;  pos = 2;  Pin Index = 97;  Pin Name = \count_reg[1].SI;  pinInvFromLatch = no;  Latch Index = 42;  Latch Name = \count_reg[1].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[2] .SI = part_S_CR_1_TM_1 [6] ,   // CR = 1;  pos = 3;  Pin Index = 176;  Pin Name = \count_reg[2].SI;  pinInvFromLatch = no;  Latch Index = 67;  Latch Name = \count_reg[2].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[3] .SI = part_S_CR_1_TM_1 [5] ,   // CR = 1;  pos = 4;  Pin Index = 255;  Pin Name = \count_reg[3].SI;  pinInvFromLatch = no;  Latch Index = 92;  Latch Name = \count_reg[3].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[4] .SI = part_S_CR_1_TM_1 [4] ,   // CR = 1;  pos = 5;  Pin Index = 334;  Pin Name = \count_reg[4].SI;  pinInvFromLatch = no;  Latch Index = 117;  Latch Name = \count_reg[4].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[5] .SI = part_S_CR_1_TM_1 [3] ,   // CR = 1;  pos = 6;  Pin Index = 413;  Pin Name = \count_reg[5].SI;  pinInvFromLatch = no;  Latch Index = 142;  Latch Name = \count_reg[5].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[6] .SI = part_S_CR_1_TM_1 [2] ,   // CR = 1;  pos = 7;  Pin Index = 492;  Pin Name = \count_reg[6].SI;  pinInvFromLatch = no;  Latch Index = 167;  Latch Name = \count_reg[6].U$1.i0.dff_primitive;   
    counter_inst.\count_reg[7] .SI = part_S_CR_1_TM_1 [1] ;   // CR = 1;  pos = 8;  Pin Index = 571;  Pin Name = \count_reg[7].SI;  pinInvFromLatch = no;  Latch Index = 192;  Latch Name = \count_reg[7].U$1.i0.dff_primitive;   

  assign // OR = 1 
    part_M_OR_1_TM_1 [1] =  counter_inst.scan_out ,   // OR = 1;  pos = 1;  Pin Index = 13;  Pin Name = scan_out;  pinInvFromLatch = no;  Latch Index = 192;  Latch Name = \count_reg[7].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [2] =  counter_inst.\count_reg[6] .Q ,   // OR = 1;  pos = 2;  Pin Index = 493;  Pin Name = \count_reg[6].Q;  pinInvFromLatch = no;  Latch Index = 167;  Latch Name = \count_reg[6].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [3] =  counter_inst.\count_reg[5] .Q ,   // OR = 1;  pos = 3;  Pin Index = 414;  Pin Name = \count_reg[5].Q;  pinInvFromLatch = no;  Latch Index = 142;  Latch Name = \count_reg[5].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [4] =  counter_inst.\count_reg[4] .Q ,   // OR = 1;  pos = 4;  Pin Index = 335;  Pin Name = \count_reg[4].Q;  pinInvFromLatch = no;  Latch Index = 117;  Latch Name = \count_reg[4].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [5] =  counter_inst.\count_reg[3] .Q ,   // OR = 1;  pos = 5;  Pin Index = 256;  Pin Name = \count_reg[3].Q;  pinInvFromLatch = no;  Latch Index = 92;  Latch Name = \count_reg[3].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [6] =  counter_inst.\count_reg[2] .Q ,   // OR = 1;  pos = 6;  Pin Index = 177;  Pin Name = \count_reg[2].Q;  pinInvFromLatch = no;  Latch Index = 67;  Latch Name = \count_reg[2].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [7] =  counter_inst.\count_reg[1] .Q ,   // OR = 1;  pos = 7;  Pin Index = 98;  Pin Name = \count_reg[1].Q;  pinInvFromLatch = no;  Latch Index = 42;  Latch Name = \count_reg[1].U$1.i0.dff_primitive;   
    part_M_OR_1_TM_1 [8] =  counter_inst.\count_reg[0] .Q ;   // OR = 1;  pos = 8;  Pin Index = 19;  Pin Name = \count_reg[0].Q;  pinInvFromLatch = no;  Latch Index = 17;  Latch Name = \count_reg[0].U$1.i0.dff_primitive;   
  ...
  initial 
    begin 
      ...
      if ( $test$plusargs ( "vcd" ) )  begin 
        $dumpfile("out.vcd"); 
        $dumpvars(0,test_scripts_FULLSCAN_counter_atpg ); 
      end  
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      SERIALCYCLE = 0; 
      SEQNUM = 0; 
      name_POs [1] = "count[0]";      // pinName = count[0]; 
      name_POs [2] = "count[1]";      // pinName = count[1]; 
      name_POs [3] = "count[2]";      // pinName = count[2]; 
      name_POs [4] = "count[3]";      // pinName = count[3]; 
      name_POs [5] = "count[4]";      // pinName = count[4]; 
      name_POs [6] = "count[5]";      // pinName = count[5]; 
      name_POs [7] = "count[6]";      // pinName = count[6]; 
      name_POs [8] = "count[7]";      // pinName = count[7]; 
  ...
  task test_cycle; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      part_PIs [3] = stim_PIs [3];      // pinName = m; testOffset = 0.000000;  scanOffset = 0.000000;  
     ...
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
      ...
      part_PIs [4] = stim_PIs [4];      // pinName = rst;  tf = +SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
      ...
      part_PIs [4] = stim_CIs [4];      // pinName = rst;  tf = +SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      for ( SCANCYCLE = 1; SCANCYCLE <= MAX; SCANCYCLE = SCANCYCLE + 1 ) begin 
        ...
        if (( part_M_OR_1_TM_1 [ 0 + SCANCYCLE ] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          ...
          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "counter", name_POs [9], PATTERN, SCANCYCLE, part_M_OR_1_TM_1 [ 0 + SCANCYCLE ] ); 
          end  
        end  
        else  begin 
