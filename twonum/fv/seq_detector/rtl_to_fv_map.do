...
# Generated on: Mon Mar 30 16:43:06 IST 2026 (Mon Mar 30 11:13:06 UTC 2026)
...
set_log_file fv/seq_detector/rtl_to_fv_map.log -replace
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  twonum.v
elaborate_design -golden -root {seq_detector} -rootonly -rootonly  
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/seq_detector/rtl_to_fv_map.log
}
