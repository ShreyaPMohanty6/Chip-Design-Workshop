...
# Generated on: Sat Mar 28 10:37:03 IST 2026 (Sat Mar 28 05:07:03 UTC 2026)
...
set_log_file fv/mux_ff_ex/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mux_ff_ex -revised fv_map
...
elaborate_design -golden -root {mux_ff_ex} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mux_ff_ex/fv_map.v.gz
elaborate_design -revised -root {mux_ff_ex}
...
#add_name_alias fv/mux_ff_ex/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/mux_ff_ex/rtl_to_fv_map.log
}
