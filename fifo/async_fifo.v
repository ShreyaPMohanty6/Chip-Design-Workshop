...
reg     [ASIZE-1:0]   wq2_rptr, wq1_rptr, rptr;
reg     [ASIZE-1:0]   rq2_wptr, rq1_wptr, wptr;
wire    rempty_val;
...
wire wfull_val;
assign wfull_val = (wq2_rptr == {~wptr[ASIZE-1 : ASIZE-2],wptr[ASIZE-2 : 0]});
